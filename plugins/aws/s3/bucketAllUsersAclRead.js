...
var PERMISSIONS = ['FULL_CONTROL', 'READ', 'READ_ACP'];

module.exports = {
    title: 'S3 Bucket All Users ACL Read',
    category: 'S3',
    description: 'Ensures S3 buckets do not allow global read ACL permissions',
    more_info: 'S3 buckets can be configured to allow anyone, regardless of whether they are an AWS user or not, to read objects from a bucket. This option should not be configured unless there is a strong business requirement.',
